...
def process_jargon(text):
    ...
    # Capture the specific Saturday this is being run
    current_date = datetime.now().strftime('%B %d, %Y')
    
    prompt = f"""
    You are an AI Expert Educator. Scan the following AI news:
    ---
    {text}
    ---
    Identify 3 technical AI terms. Provide a definition and a car/kitchen analogy for each.
